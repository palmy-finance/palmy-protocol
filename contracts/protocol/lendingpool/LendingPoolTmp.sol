 ...
 **/
contract LendingPoolTmp is VersionedInitializable, ILendingPool, LendingPoolStorage {
  ...
  function initReserve(
    ...
    //    );
    _reserves[asset].stableDebtTokenAddress = stableDebtAddress;
    _reserves[asset].lTokenAddress = lTokenAddress;
    _reserves[asset].variableDebtTokenAddress = variableDebtAddress;
